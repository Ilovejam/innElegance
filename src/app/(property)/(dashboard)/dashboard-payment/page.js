...
import PaymentInfo from "@/components/property/dashboard/dashboard-payment/PaymentInfo";
            ...
            <div className="dashboard__content bgc-f7">
              ...
              <div className="row">
                <div className="col-xl-12">
                  ...
                  <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                    <h4 className="title fz17 mb30">Kart Bilgileri</h4>
                    <ChangePasswordForm />
                  </div>
                  {/* End .ps-widget */}
                </div>
