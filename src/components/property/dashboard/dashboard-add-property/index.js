      ...
      <div className="tab-content" id="nav-tabContent">
        ...
        >
          <div className="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
            <h4 className="title fz17 mb30">Mülk Açıklamaları</h4>
            <PropertyDescription />
          </div>
        </div>
        ...
        >
          <div className="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
            <h4 className="title fz17 mb30">Konum Bilgileri</h4>
            <LocationField />
          </div>
        </div>
        ...
        >
          <div className="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
            <h4 className="title fz17 mb30">İlan Detayları</h4>
            <DetailsFiled />
          </div>
        </div>
        ...
        >
          <div className="ps-widget bgc-white bdrs12 p30 overflow-hidden position-relative">
            <h4 className="title fz17 mb30">Olanakları Seçin</h4>
            <div className="row">
              <Amenities />
            </div>
          </div>
